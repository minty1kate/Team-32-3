...
public class HallStartDialogue : MonoBehaviour
{
    ...
    void TriggerHallDialogue()
    {
        if (_dialogueManager != null)
        {
            ...
            {
                "Что за монстр добрался до моей прихожей!! Везде расставил свои свечи, от этого запаха уже кружится голова. Похоже он не уйдет, пока не избавится от меня.",
                "Я видел его лицо сквозь полумрак. В его глазах столько холодной, пугающей злости... Он ведь даже не пытается понять, кто я. Для него я просто враг.",
